    ...
    for (i = 0; i < window.products.products.length; i++) {
        ...
        cells[i].innerHTML = `
            <div>
                ...
                <br>
                <button type="button" style="background-color: red" onclick="subtract(${i})">-</button> Quantity: <span id="product-${i}">0</span> <button type="button" style="background-color: #03a300" onclick="add(${i})">+</button>
            </div>
        `;
